...
export class BookingController {
  ...
  async createbooking(
    @Request() req,
    @Body()
    body: CreateBookingDto & { successUrl?: string; cancelUrl?: string },
  ...
  async getBookingCheckoutLink(
    ...
    const bookingWithCheckout =
      await this.bookingService.getBookingWithCheckoutLink(
        bookingId,
        userId,
        userEmail,
        successUrl,
  ...
  async getMyBookings(
    ...
    return this.bookingService.getUserBookingStatus(
  ...
  async getBookingStatus(@Param('bookingId') bookingId: string, @Req() req) {
    return this.bookingService.getBookingStatusByBookingId(
      req.user.customer_id,
      bookingId,
    );
  }
  ...
  async getBookingStatusbyAdmin(
    @Param('bookingId') bookingId: string,
    @Req() req,
  ) {
    return this.bookingService.getBookingStatusByBookingIdByAdmin(
      req.user.customer_id,
      bookingId,
    );
  }
